...
<aside
  ...
  class="absolute z-10 ml-auto mr-5 right-0 -mt-10 min-[700px]:-mt-0 border-2 border-gray-600 rounded-md bg-black text-white"
>
  <div class="p-4 pr-14 flex gap-4">
  ...
  <a class="flex items-center p-5 gap-2 hover:bg-semi-gray duration-200" href="/people/{$user.username}">
    <div class="h-4">
      <FaUser />
    </div>
